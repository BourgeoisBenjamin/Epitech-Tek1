...
{
    t_game_object *list_obj = init_objs_end_scene();
    t_button *list_button = init_buttons_end_scene();
    t_text *list_text = init_texts_end_scene();
    t_music *list_music = init_musics_end_scene();
