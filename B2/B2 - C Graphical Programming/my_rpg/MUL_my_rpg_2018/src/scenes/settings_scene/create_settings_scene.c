...
{
    t_game_object *list_obj = init_objs_settings_scene();
    t_button *list_button = init_buttons_settings_scene();
    t_text *list_text = init_texts_settings_scene();
    t_music *list_music = init_musics_settings_scene();
