...
{
    t_music *background = create_music("ressources/soundtrack/intro_music.ogg",
    50, 1, BACKGROUND_M);
...
t_music *init_musics_intro_scene(void)
{
    ...
    if ((list_music = create_background_music_intro_scene(list_music)) == NULL)
        return (NULL);
    return (list_music);
}
